...
void setup(void)
{
  ...
  {
    role = role_sender;
    Serial.write("Role: sender");
    }
  else
  {
    role = role_receiver;
    Serial.write("Role: receiver");
  }
  ...
  if (configuration == '4' && role == role_sender)
  {
    ...
    radio.openReadingPipe(1,pipe & 0xF0F0F0F0D2LL);
